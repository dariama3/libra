    ...
    <div class="flex flex-col gap-4 my-2">
      <div class="flex flex-col gap-1">
        ...
        <input
          ...
          class="w-full px-3 py-2 rounded-lg border text-sm outline-none transition-colors bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700 text-gray-800 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:border-[var(--color-brand)] focus:ring-2 focus:ring-[var(--color-brand-light)]"
        />
