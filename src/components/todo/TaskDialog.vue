...
<template>
  <Dialog
    ...
    :pt="{
      ...
      header: { class: 'bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100 border-b border-gray-200 dark:border-gray-700 px-6 py-4' },
      ...
      <div class="flex flex-col gap-1">
        ...
        <input
          ...
          class="w-full px-3 py-2 rounded-lg border text-sm outline-none transition-colors
            ...
            focus:border-[var(--color-brand)] focus:ring-2 focus:ring-[var(--color-brand-light)]"
        />
